...
{% include asciicast-custom.html rows='41' cols='50' source='explore-drug-database-1-29-2017.json' title='R Analysis in a Container' author='vsochat@stanford.edu' %}
...
<strong>1. install nginx</strong> web server<br>
